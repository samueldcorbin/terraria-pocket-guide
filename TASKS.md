...
## Completed
- [x] Research tModLoader dev workflow — see tasks/tmodloader-dev-workflow.md
- [x] Scaffold tModLoader project (build.txt, .csproj, Mod class, .gitignore) — see tasks/scaffold-project.md
- [x] Finish rename to PocketGuide — see tasks/finish-rename.md
